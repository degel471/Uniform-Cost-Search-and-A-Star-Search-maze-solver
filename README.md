...
If you want visualization, please release all #comments .
If you don't want visualization, leave the # on these following function below.
```python
...
Step to exacute
1. Go to directory. : HW1
2. Use the following command on the c/~/HW1
